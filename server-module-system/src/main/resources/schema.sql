...
-- register 分组配置
    ('2083480854738399249', '2083480854738399233', '开放注册', 'enabled', 'true', 'register', 1),
...
-- email 分组配置
    ...
    ('2083480854738399273', '2083480854738399233', '启用邮件', 'enabled', 'false', 'email', 1),
-- emailTemplate 分组配置
    ('2083480854738399274', '2083480854738399233', '验证码模板', 'verifyCode', '您的验证码为{code}，请于{minutes}分钟内完成验证。', 'emailTemplate', 1),
    ('2083480854738399275', '2083480854738399233', '重置密码模板', 'resetPassword', '您的密码已重置为{password}，请登录后尽快修改。', 'emailTemplate', 1),
    ('2083480854738399276', '2083480854738399233', '欢迎模板', 'welcome', '欢迎注册{siteName}，祝您使用愉快！', 'emailTemplate', 1),
-- sms 分组配置
    ('2083480854738399277', '2083480854738399233', '服务商', 'provider', 'aliyun', 'sms', 1),
    ...
    ('2083480854738399285', '2083480854738399233', '启用短信', 'enabled', 'false', 'sms', 1),
-- smsTemplate 分组配置
    ('2083480854738399286', '2083480854738399233', '验证码模板内容', 'verifyCode', '您的验证码为{code}，请于{minutes}分钟内完成验证。', 'smsTemplate', 1),
    ('2083480854738399287', '2083480854738399233', '重置密码模板内容', 'resetPassword', '您的密码已重置为{password}，请登录后尽快修改。', 'smsTemplate', 1),
    ('2083480854738399288', '2083480854738399233', '通知模板内容', 'notification', '', 'smsTemplate', 1),
-- storage 分组配置
    ('2083480854738399289', '2083480854738399233', '存储服务商', 'provider', 'local', 'storage', 1),
...
-- thirdParty 分组配置
    ('2083480854738399316', '2083480854738399233', '启用微信', 'wechatEnabled', 'false', 'thirdParty', 1),
    ('2083480854738399317', '2083480854738399233', '微信AppID', 'wechatAppId', '', 'thirdParty', 1),
    ('2083480854738399318', '2083480854738399233', '微信密钥', 'wechatSecret', '', 'thirdParty', 1),
    ('2083480854738399319', '2083480854738399233', '启用支付宝', 'alipayEnabled', 'false', 'thirdParty', 1),
    ('2083480854738399320', '2083480854738399233', '支付宝AppID', 'alipayAppId', '', 'thirdParty', 1),
    ('2083480854738399321', '2083480854738399233', '支付宝私钥', 'alipayPrivateKey', '', 'thirdParty', 1),
    ('2083480854738399322', '2083480854738399233', '支付宝公钥', 'alipayPublicKey', '', 'thirdParty', 1),
...
-- wechatMiniProgram 分组配置
    ('2083480854738399326', '2083480854738399233', '启用小程序', 'enabled', 'false', 'wechatMiniProgram', 1),
    ('2083480854738399327', '2083480854738399233', 'AppID', 'appId', '', 'wechatMiniProgram', 1),
    ('2083480854738399328', '2083480854738399233', '密钥', 'secret', '', 'wechatMiniProgram', 1),
-- wechatMp 分组配置
    ('2083480854738399329', '2083480854738399233', '启用公众号', 'enabled', 'false', 'wechatMp', 1),
    ('2083480854738399330', '2083480854738399233', 'AppID', 'appId', '', 'wechatMp', 1),
    ('2083480854738399331', '2083480854738399233', '密钥', 'secret', '', 'wechatMp', 1),
...
-- payment 分组配置
    ('2083480854738399337', '2083480854738399233', '启用微信支付', 'wechatEnabled', 'false', 'payment', 1),
    ('2083480854738399338', '2083480854738399233', '商户号', 'wechatMchId', '', 'payment', 1),
    ('2083480854738399339', '2083480854738399233', 'AppID', 'wechatAppId', '', 'payment', 1),
    ...
    ('2083480854738399344', '2083480854738399233', '启用支付宝', 'alipayEnabled', 'false', 'payment', 1),
    ('2083480854738399345', '2083480854738399233', 'AppID', 'alipayAppId', '', 'payment', 1),
    ('2083480854738399346', '2083480854738399233', '应用私钥', 'alipayPrivateKey', '', 'payment', 1),
    ('2083480854738399347', '2083480854738399233', '公钥', 'alipayPublicKey', '', 'payment', 1),
